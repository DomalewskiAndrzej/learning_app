...
import { TimeToCompleteValidator } from '@app/app/to-do/shared';

@Component({
  selector: 'app-ui-to-do-add-edit-dialog',
  templateUrl: './ui-to-do-add-edit-dialog.component.html',
  styleUrls: ['./ui-to-do-add-edit-dialog.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class UiToDoAddEditDialogComponent implements OnInit {
  form: FormGroup;
  error = false;
  ...
  constructor(
    public dialogRef: MatDialogRef<UiToDoAddEditDialogComponent>,
